export default {
    ...
    mutations: {
        wsInit(state, ws) {
            ...
            if (isHttps) {
                state.ws = new WebSocket('wss://swfk.shoupinkangda.cn/wss/');
            } else {
                state.ws = new WebSocket('ws://122.114.0.46:8296');
                // state.ws = new WebSocket('ws://192.168.8.189:8296');
                // state.ws = new WebSocket('ws://192.168.2.189:8296');
            }
        },
