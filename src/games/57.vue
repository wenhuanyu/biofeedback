...
<template>
    <div class="container">
        <div class="background">
            <ul :class="started">
                <li><img src="../assets/games/57/1.png"></li>
                <li><img src="../assets/games/57/2.png"></li>
                <li><img src="../assets/games/57/3.png"></li>
            </ul>
        </div>
        <div class="hezi">
            <div v-for="(item,index) in biscuits.slice(0,10)" style="margin-top: -170px;">
                <div style="width: 15%;" :style="{marginLeft:item.num + 'px'}">
                    ...
                    <img :src="require(`../assets/games/57/`+index+`.gif`)" style="width: 100px;height: 80px;">
                </div>
            </div>
        </div>
        <div class="hezi_">
