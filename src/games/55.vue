...
<template>
    <div class="container">
        <div class="background">
            <ul :class="started">
                <li><img src="../assets/games/55/bj1.png"></li>
                <li><img src="../assets/games/55/bj2.png"></li>
                <li><img src="../assets/games/55/bj3.png"></li>
            </ul>
        </div>
        <div class="hezi" >
            <div v-for="item in biscuits.slice(0,10)" :class="started"  style="margin-top: -50px;">
                <div style="width: 15%;" :style="{marginLeft:item.num + 'px'}">
                    ...
                    <img src="../assets/games/55/hx.gif" style="width: 150px;height: 100px;">
                </div>
            </div>
        </div>
        <div class="hezi_" >
            <div v-for="item in biscuits.slice(10,20)" :class="started"  style="margin-top: -50px;">
                <div style="width: 15%;" :style="{marginLeft:item.num + 'px'}">
                    <div v-if="item.is_self == 1" :class="item.status==0?'dd':'de'">
                        <div class="d1">{{item.name}}</div>
                        <div class="d2">数值：{{item.value}}</div>
