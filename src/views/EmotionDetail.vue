    ...
    <div class="content" v-if="isFinished">
        <div class="content_top">
            ...
            <div>
                ...
                <el-button style="background-color:rgb(96, 167, 235)!important;border: none!important; color: #ffffff;" plain @click="fanhui" icon="el-icon-arrow-left">
                    返回上一页
                </el-button>
            </div>
        </div>
        ...
        <el-dialog class="new-dialog text-dialog" title="修改报告" :visible.sync="dialogReport" width="50%"
            ...
            <div style="width: 75%;">
                <el-form label-width="120px" style="max-height: unset;">
                    ...
                    <el-form-item label="训练时间" prop="exam_time">
                        <el-date-picker type="date" placeholder="选择日期" style="width:100%" value-format="yyyy-MM-dd"
                    ...
                    <el-form-item label="病区" prop="district_id">
